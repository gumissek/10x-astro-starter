...
const DeleteFlashcardDialog: React.FC<DeleteFlashcardDialogProps> = ({ isOpen, flashcard, onClose, onConfirm }) => {
        ...
        <DialogHeader>
          ...
          <DialogDescription asChild>
            <div className="space-y-3">
              <p>Czy na pewno chcesz usunąć tę fiszkę? Tej akcji nie można cofnąć.</p>

              {flashcard && (
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 space-y-3">
                  <div>
                    <span className="text-sm font-medium text-gray-700">Front:</span>
                    <p className="text-sm text-gray-900 mt-1">{truncateText(flashcard.front)}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-gray-700">Back:</span>
                    <p className="text-sm text-gray-900 mt-1">{truncateText(flashcard.back)}</p>
                  </div>
